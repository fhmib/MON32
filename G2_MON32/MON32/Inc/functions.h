...
typedef enum {
  ...
  MSG_TYPE_PRO_CTL_RAISING_ISR,
  MSG_TYPE_PRO_CTL_FALLING_ISR,
  MSG_TYPE_SELF_CHECK_SWITCH_STEP_1,
  MSG_TYPE_SELF_CHECK_SWITCH_STEP_2,
  MSG_TYPE_SELF_TEST,
  ...
  MSG_TYPE_SWITCH_WAVELENGTH,
  MSG_TYPE_RUN_SELFCHECK,
} MsgType;
...
typedef enum {
  TAP_PD_C98_CHANNEL  = 0,
  TAP_PD_C122_CHANNEL = 1,
  RX_PD_C98_CHANNEL   = 2,
  RX_PD_C122_CHANNEL  = 3,
  VOLTAGE_5_0_CHANNEL = 4,
  VOLTAGE_61_0_CHANNEL = 5,
  TEMPERATURE_CHANNEL = 6,
  VOLTAGE_3_3_CHANNEL = 7,
} VoltageAdcChannel;

typedef enum {
  TEC_ADC_C98_TEC_TEMP_CHANNEL      =  0,
  TEC_ADC_C98_TEC_VOLTAGE_CHANNEL   =  1,
  TEC_ADC_C98_TEC_CURRENT_CHANNEL   =  2,
  TEC_ADC_C98_LD_CURRENT_CHANNEL    =  3,
  TEC_ADC_C98_LD_VOLTAGE_CHANNEL    =  4,
  TEC_ADC_C98_MPD_CURRENT_CHANNEL   =  5,
  TEC_ADC_C122_TEC_TEMP_CHANNEL     =  8,
  TEC_ADC_C122_TEC_VOLTAGE_CHANNEL  =  9,
  TEC_ADC_C122_TEC_CURRENT_CHANNEL  = 10,
  TEC_ADC_C122_LD_CURRENT_CHANNEL   = 11,
  TEC_ADC_C122_LD_VOLTAGE_CHANNEL   = 12,
  TEC_ADC_C122_MPD_CURRENT_CHANNEL  = 13,
  TEC_ADC_VOLTAGE_4_4_CHANNEL       = 15,
} TecAdcChannel;
...
typedef enum {
  ...
  DAC128S085_TOSA_POWER_CHANNEL = 3,
} DAC128S085Channel;
...
typedef struct {
  ...
  uint32_t osc_flag; // Optical path self-check flag. bit0:Init bit1:C98 FAIL bit2:C122 FAIL bit3:ongoing
